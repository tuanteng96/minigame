export default function FindLocationText({
    ...
    const ChuViNho = width / 550 * CenterDistance;
    ...
    function start_values() {
        for (let i = 0; i < initialValues.length; i++) {
            ...
            initialValues[i].fontSize = width / 550 * fontSizeD;
            initialValues[i].width = width / 550 * widthD;
            initialValues[i].height = width / 550 * heightD;
